...
export class BetaInvitationService {
  ...
  private setupServices(): void {
    // Setup SendGrid
    if (process.env.SENDGRID_API_KEY && process.env.SENDGRID_API_KEY.trim() !== '' && !process.env.SENDGRID_API_KEY.includes('your_')) {
      try {
    ...
    // Setup Twilio - validate credentials before initializing
