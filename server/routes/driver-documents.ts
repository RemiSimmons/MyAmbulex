...
const upload = multer({
  storage: multer.diskStorage({
    ...
    filename: (req, file, cb) => {
      ...
      cb(null, `${documentType}-${timestamp}-${random}${ext}`);
    }
  }),
  limits: {
  ...
  try {
    ...
    switch (documentType) {
      case 'licensePhotoFront':
        ...
        updateData.licenseVerified = null; // Set to pending (null = under review) // Reset verification when new document uploaded
